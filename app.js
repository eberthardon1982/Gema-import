    ...
    try{
      ...
      if(modo==="vehiculo"&&selVeh){
        ...
        const instrucciones={
          ...
          facebook:`Crea un post para Facebook e Instagram anunciando este vehículo. Incluye: gancho inicial llamativo, descripción del vehículo con sus puntos fuertes, precio en Lempiras y dólares, llamada a la acción. Máximo 200 palabras. Sugiere 3 hashtags para Honduras. En español hondureño.`,
...
IMPORTANTE: El contenido debe sonar humano y natural, no como robot. Que genere emoción y deseo de compra. En Honduras el precio en Lempiras impacta más que en dólares para el consumidor final.`;
        ...
        const instrEdu={
          ...
          facebook:`Crea un post educativo de Facebook sobre: "${tema}". Que sea informativo y útil, posicionando a ${empresa} como expertos. Incluye datos concretos, usa lenguaje de Honduras. Al final, llamada sutil a la acción. Con hashtags sugeridos.`,
