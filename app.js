    ...
    try{
      ...
      if(modo==="vehiculo"&&selVeh){
        ...
        const instrucciones={
          ...
          twitter:`Crea un hilo de Twitter/X de 3-4 tweets anunciando este vehículo. Cada tweet máximo 280 caracteres. El primero debe ser el gancho que hace parar el scroll. Incluye precio en Lempiras. Usar hashtags relevantes. En español hondureño.`, Incluye: gancho inicial llamativo, descripción del vehículo con sus puntos fuertes, precio en Lempiras y dólares, llamada a la acción. Máximo 200 palabras. Sugiere también 3 hashtags relevantes para Honduras. En español hondureño.`,
...
IMPORTANTE: El contenido debe sonar humano y natural, no como robot. Que genere emoción y deseo de compra. En Honduras el precio en Lempiras impacta más que en dólares para el consumidor final.`;
        ...
        const instrEdu={
          ...
          twitter:`Crea un hilo de 4 tweets educativos sobre: "${tema}". Cada tweet máximo 280 caracteres. Que el primero sea un dato sorprendente. Con hashtags. En español.`, Que sea informativo y útil, posicionando a ${empresa} como expertos. Incluye datos concretos, usa lenguaje de Honduras. Al final, llamada sutil a la acción. Con hashtags sugeridos.`,
